        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] text-[var(--fm-accent)] uppercase tracking-[0.2em] mt-1 font-bold font-[family-name:var(--font-inter)] leading-none">
              TSP-POWERED LAST-MILE ORCHESTRATOR
            </p>
          </div>
        </div>
            ...
            <div className="relative flex h-2 w-2 items-center justify-center">
              ...
              <span
                className={`relative inline-flex h-2 w-2 rounded-full ${
                  isConnected ? "bg-[var(--fm-success)] shadow-[0_0_5px_var(--fm-success)]" : connectionError ? "bg-[var(--fm-danger)]" : "bg-[var(--fm-warning)]"
                }`}
              />
            </div>
            <span
              className={`text-[11px] font-bold tracking-widest uppercase font-[family-name:var(--font-space-grotesk)] ${
                isConnected ? "text-[var(--fm-success)]" : connectionError ? "text-[var(--fm-danger)]" : "text-[var(--fm-warning)]"
              }`}
            >
              {statusLabel}
            </span>
